...
def main(env_name, lr_mu, lr_q, tau, gamma, batch_size, buffer_limit, max_episodes, log_interval, test_episodes,
    ...
    #q_target.load_state_dict(torch.load('/Users/mingliu/Documents/R Learning/Final Project Code/agent3_grid6/q_target_NO_OBS_agents3_grid6.pt'))
    ...
    #mu_target.load_state_dict(torch.load('/Users/mingliu/Documents/R Learning/Final Project Code/agent3_grid6/mu_target_NO_OBS_agents3_grid6.pt'))
...
#-- greedy
            ...
            if episode_i % render_interval == 0: # Render the tests
                ...
                torch.save(q_target.state_dict(),'G_q_target_NO_OBS_agents{}_grid{}.pt'.format(n_agents,grid_size))
                torch.save(mu_target.state_dict(),'G_mu_target_NO_OBS_agents{}_grid{}.pt'.format(n_agents,grid_size))
...
if __name__ == '__main__':
    ...
    mapsize = 6 # Pair change to 6, Emily change to 10
    ...
    if USE_WANDB:
        import wandb
        wandb.init(project='Greedy_Agent{}Size{}'.format(n_agent,mapsize), config={'type':'NOOBS','algo': 'maddpg', **kwargs, }, monitor_gym=True)
